...
#need to deal with multiple switches? maybe provide ingress & eggress switch specifications
#need to come up with something to remove forwarding rules

def writeForwarding(p4info_helper, ingress_sw, egress_sw, tunnel_id,
